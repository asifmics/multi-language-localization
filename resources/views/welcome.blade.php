            ...
            @else
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false"
                         class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg border border-gray-200">
                        <a href="locale/en" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">En</a>
                        <a href="locale/bn" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Bn</a>
                    </div>
                </div>
            @endauth
        </nav>
...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            class="text-[13px] text-center leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
            <h1 class="mb-1 font-medium">@lang('settings.welcome')</h1>
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">@lang('settings.message')</p>
        </div>
    </main>
</div>
